...
router.get('/posts', feedController.getPosts); // this is the route to our posts. When a request reaches this it goes to the controllers/feed.js and executes the 'getPosts' logic there.
