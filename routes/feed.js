...
const { body } = require('express-validator/check'); // brings in 'express-validator' check module and assigns it to the 'body' value to check the body. We could have said 'check' instead of body to check headers, query parameters etc.
